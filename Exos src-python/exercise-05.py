...
# réponse 5.1
if number == 1:
    print(f"le nombre {number} est égal à 1")
else:
    print(f"le nombre {number} est différent de 1")
...
# réponse 5.3
if number % 3 == 0:
    print(f"le nombre {number} est divisible par 3")
else:
    print(f"le nombre {number} n'est pas divisible par 3")
...
# réponse 5.4
if number >= 5:
    print(f"le nombre {number} est supérieur ou égal à 5")
else:
    print(f"le nombre {number} est inférieur à 5")
...
if number >= 0 and number <= 49:
    print(f"le nombre {number} est compris entre 0 et 49 inclus")
else:
    print(f"le nombre {number} n'est pas compris entre 0 et 49 inclus")
...
if number >= 0 and number <= 33:
    print(f"le nombre {number} est compris entre 0 et 33 inclus")
elif number >= 34 and number <= 66:
    print(f"le nombre {number} est compris entre 34 et 66 inclus")
else:
    print(f"le nombre {number} n'est pas compris entre 0 et 66 inclus")
...
# réponse 5.7
if a > b:
    print(f"le nombre a ({a}) est supérieur au nombre b ({b})")
elif b > a:
    print(f"le nombre b ({b}) est supérieur au nombre a ({a})")
else:
